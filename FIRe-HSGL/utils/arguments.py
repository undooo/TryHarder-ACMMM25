...
def get_args():
    ...
    parser.add_argument('--save_checkpoint', default=True, action='store_true', help='save model checkpoint')
    ...
    parser.add_argument('--trip_weight', type=float, default=0.0,
                        help="weight of the triplet loss")


    parser.add_argument('--iter_log_period', type=int, default=5,
                        help="period of logging iteration information")
    parser.add_argument('--model_name', type=str, default='hdetector',
                        help="model name")
    ...
    if args.extra_data_path == "None":
        args.extra_data_path = None
    return args
