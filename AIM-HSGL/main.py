...
from train_HD import train_aim_HD
...
def main(config):
    ...
    for epoch in range(start_epoch, config.TRAIN.MAX_EPOCH):
        ...
        if config.LOSS.USE_TRIPLET_HD == False:
            ...
            train_aim_HD(config, epoch, model, model2, classifier, clothes_classifier, clothes_classifier2, fuse, criterion_cla, criterion_pair,
            criterion_clothes, criterion_adv, optimizer, optimizer2, optimizer_cc, trainloader, pid2clothes, kl)
        ...
        if (epoch+1) > config.TEST.START_EVAL and config.TEST.EVAL_STEP > 0 and \
            ...
            if hasattr(clothes_classifier, 'module'):
            ...
            if hasattr(clothes_classifier2, 'module'):
